...
mod tests {
    ...
    fn test_aggregate_consistency() {
        ...
        assert_eq!(CommandAction::CreateConfiguration.aggregate(), Aggregate::Configuration);
        assert_eq!(EventAction::ConfigurationCreated.aggregate(), Aggregate::Configuration);
        assert_eq!(QueryAction::GetConfiguration.aggregate(), Aggregate::Configuration);
    }
